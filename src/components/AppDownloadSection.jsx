...
// import AppImage from "../assets/section2.png"; // Ensure image has transparent background
...
import React from "react";
import { FaApple, FaGooglePlay } from "react-icons/fa";
import AppImage from "../assets/section2.png"; // Your uploaded image
      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 flex justify-center">
          <img
            src={AppImage}
            alt="Taxi App Preview"
            className="w-full max-w-[220px] sm:max-w-[280px] md:max-w-[320px] lg:max-w-[360px] bg-transparent"
          />
        </div>
      </div>
    </section>
