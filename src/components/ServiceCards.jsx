...
const cards = [
  ...
  { title: "Fordons Rapporter", description: "Följ varje fordons kostnader, intäkter, vinst och marginaler i realtid – siffrorna hämtas automatiskt från anställdas rapporter eller kan läggas in manuellt. Rapporter kan laddas ner för revisorn och sparas i systemet.", image: Image7 },
  { title: "Arbetsgivarintyg", description: "Skapa arbetsgivarintyg snabbt och korrekt – all data hämtas automatiskt från personalregistret för att spara tid och undvika fel.", image: Image8 },
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-20">
      ...
      <div
        ...
        className={`flex flex-row gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide
          ${activeCard !== null ? "pb-40" : "pb-12"} pt-12`}
