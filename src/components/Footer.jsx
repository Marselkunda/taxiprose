        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-5 text-2xl">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/profile.php?id=61579966582944"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-[#ffc001] transition"
              >
                <FaFacebookF />
              </a>
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/taxipro.se/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-[#ffc001] transition"
              >
              ...
              {/* Twitter (dummy link, no redirect) */}
              <a
                href="#"
